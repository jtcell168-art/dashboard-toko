...
export default function StoreFrontClient({ products }) {
  ...
  const [activeBranch, setActiveBranch] = useState("Ruteng");
  ...
  return (
    <div className="min-h-screen bg-[#0A0E1A] text-white overflow-hidden relative">
      ...
      <main className="pt-32 pb-20">
        ...
        <div className="max-w-7xl mx-auto px-6 mt-32">
          ...
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/20 text-violet-400 text-sm font-medium mb-6">
              ...
              Program Kredit Resmi JTCell
            </div>
            <h2 className="text-3xl md:text-5xl font-bold mb-4 leading-tight">
              Upgrade HP Tanpa Harus{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-indigo-400">
                Bayar Full
              </span>
            </h2>
            <p className="text-white/50 text-base max-w-lg mx-auto">
              Kini di JTCell bisa kredit HP dengan proses cepat, langsung cek limit di tempat.
            </p>
          </div>

          {/* Main Card */}
          <div className="relative rounded-3xl overflow-hidden border border-white/5 bg-gradient-to-br from-[#0F0C29]/80 via-[#302B63]/40 to-[#24243E]/80 backdrop-blur-xl shadow-2xl">
            {/* Decorative blobs */}
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <p className="text-violet-400 text-xs font-bold uppercase tracking-widest mb-3">Mitra Pembiayaan Resmi</p>
                <h3 className="text-2xl md:text-3xl font-extrabold text-white mb-6 leading-snug">
                  Cicil HP Impian Anda <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-cyan-400">Mulai Dari Sekarang</span>
                </h3>

                {/* Partner Badges */}
                <div className="flex flex-wrap gap-4 mb-8">

                  {/* Kredivo — Inline SVG Logo */}
                  <div className="flex items-center gap-3 px-5 py-3.5 rounded-2xl bg-white/5 border border-white/10 hover:border-violet-500/30 hover:bg-violet-500/5 transition-all duration-300 group cursor-default">
                    <div className="w-16 h-10 shrink-0 flex items-center justify-center">
                      {/* Kredivo logo: K mark (blue+orange) + redivo text */}
                      <svg viewBox="0 0 108 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                        {/* Left blue vertical bar of K */}
                        <rect x="0" y="0" width="8" height="36" rx="2" fill="#29ABE2"/>
                        {/* Orange upper-right diagonal of K */}
                        <path d="M8 0 L21 0 L13.5 18 L8 18 Z" fill="#F5821F"/>
                        {/* Blue lower-right diagonal of K */}
                        <path d="M8 18 L13.5 18 L21 36 L8 36 Z" fill="#29ABE2"/>
                        {/* "redivo" lettering */}
                        <text x="25" y="26" fontFamily="Arial, Helvetica, sans-serif" fontWeight="800" fontSize="17" fill="#29ABE2" letterSpacing="-0.3">redivo</text>
                      </svg>
                    </div>
                    <div>
                      <p className="text-white font-extrabold text-sm tracking-wide group-hover:text-violet-300 transition-colors">Kredivo</p>
                      <p className="text-white/40 text-[10px] leading-tight">Cicilan 0% s/d 12 bulan</p>
                      <p className="text-white/25 text-[9px] leading-tight mt-0.5 italic">*tergantung hasil pengecekan & promo berlaku</p>
                    </div>
                  ...
                  {/* Vast Finance — Inline SVG Logo */}
                  <div className="flex items-center gap-3 px-5 py-3.5 rounded-2xl bg-white/5 border border-white/10 hover:border-indigo-500/30 hover:bg-indigo-500/5 transition-all duration-300 group cursor-default">
                    <div className="w-16 h-10 shrink-0 flex items-center justify-center">
                      {/* Vast Finance logo */}
                      <svg viewBox="0 0 108 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                        {/* Blue wave/swoosh accent under "Vast" */}
                        <path d="M0 28 Q14 22 28 28" stroke="#2563EB" strokeWidth="2.5" strokeLinecap="round" fill="none"/>
                        {/* "Vast" bold text */}
                        <text x="0" y="22" fontFamily="Arial, Helvetica, sans-serif" fontWeight="900" fontSize="20" fill="white" letterSpacing="-0.5">Vast</text>
                        {/* "Finance" lighter text */}
                        <text x="42" y="22" fontFamily="Arial, Helvetica, sans-serif" fontWeight="600" fontSize="14" fill="#94A3B8" letterSpacing="0">Finance</text>
                        {/* "by Kredivo" micro text */}
                        <text x="1" y="35" fontFamily="Arial, Helvetica, sans-serif" fontWeight="400" fontSize="7" fill="#64748B">by Kredivo</text>
                      </svg>
                    </div>
                    <div>
                      <p className="text-white font-extrabold text-sm tracking-wide group-hover:text-indigo-300 transition-colors">Vast Finance</p>
                      <p className="text-white/40 text-[10px] leading-tight">Proses cepat & mudah</p>
                      <p className="text-white/25 text-[9px] leading-tight mt-0.5 italic">*tergantung hasil pengecekan & promo berlaku</p>
                    </div>
                    <span className="ml-auto text-emerald-400">
                      <span className="material-symbols-outlined text-[18px]">verified</span>
                ...
                {/* CTA Button */}
                <a
                  href="https://wa.me/6281246050589?text=Halo%20JTCell,%20saya%20ingin%20info%20kredit%20HP%20melalui%20Kredivo%20atau%20Vast%20Finance.%20Bisa%20bantu%20saya%3F"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 text-white font-bold text-base transition-all duration-300 shadow-xl shadow-violet-500/25 active:scale-95 group w-full sm:w-fit"
                >
              ...
              {/* Right: How To Apply */}
              <div className="p-8 md:p-12 border-t border-white/5 lg:border-t-0 lg:border-l lg:border-white/5 flex flex-col justify-center">
                <div className="flex items-center gap-2 mb-6">
                  <div className="w-8 h-8 rounded-xl bg-indigo-500/20 flex items-center justify-center border border-indigo-500/20">
                    <span className="material-symbols-outlined text-indigo-400 text-[18px]">checklist</span>
                  </div>
                  <p className="text-white font-bold text-base">Cara Pengajuan</p>
                </div>

                <div className="space-y-4">
                  {[
                    { icon: "storefront", label: "Datang ke toko JTCell", color: "violet" },
                    { icon: "smartphone", label: "Bawa smartphone pribadi", color: "indigo" },
                    { icon: "badge", label: "Bawa KTP fisik asli", color: "cyan" },
                    { icon: "sim_card", label: "Gunakan nomor HP aktif", color: "emerald" },
                  ].map((step, i) => {
                    const colorMap = {
                      violet: { bg: "bg-violet-500/10", border: "border-violet-500/20", text: "text-violet-400", num: "bg-violet-500" },
                      indigo: { bg: "bg-indigo-500/10", border: "border-indigo-500/20", text: "text-indigo-400", num: "bg-indigo-500" },
                      cyan:   { bg: "bg-cyan-500/10",   border: "border-cyan-500/20",   text: "text-cyan-400",   num: "bg-cyan-500" },
                      emerald:{ bg: "bg-emerald-500/10",border: "border-emerald-500/20",text: "text-emerald-400",num: "bg-emerald-500" },
                    };
                    const c = colorMap[step.color];
                    return (
                      <div key={i} className={`flex items-center gap-4 p-4 rounded-2xl ${c.bg} border ${c.border} transition-all duration-300 hover:scale-[1.01]`}>
                        <div className={`w-9 h-9 rounded-xl ${c.bg} border ${c.border} flex items-center justify-center shrink-0`}>
                          <span className={`material-symbols-outlined ${c.text} text-[20px]`}>{step.icon}</span>
                        </div>
                        <p className="text-white/80 text-sm font-medium leading-tight">{step.label}</p>
                        <span className={`ml-auto w-6 h-6 rounded-full ${c.num} text-white text-[10px] font-bold flex items-center justify-center shrink-0`}>{i + 1}</span>
                      </div>
                    );
                  })}
                </div>
                ...
                <div className="mt-6 p-4 rounded-2xl bg-emerald-500/5 border border-emerald-500/15 flex items-start gap-3">
                  <span className="material-symbols-outlined text-emerald-400 text-[20px] mt-0.5 shrink-0">tips_and_updates</span>
                  <p className="text-emerald-300/80 text-xs leading-relaxed">
                    Tim kami akan bantu cek limit Anda langsung di tempat. Jika limit tersedia,{" "}
                    <span className="font-bold text-emerald-300">HP bisa langsung dibawa pulang hari itu juga.</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* FLORES MAP BRANCH SECTION */}
        <div className="max-w-7xl mx-auto px-6 mt-32">
          <div className="text-center md:text-left mb-12">
            <h2 className="text-3xl font-extrabold mb-3 flex items-center justify-center md:justify-start gap-2">
              <span className="material-symbols-outlined text-indigo-400 text-[28px]">explore</span>
              Jaringan Cabang Flores
            </h2>
            <p className="text-white/60 text-sm max-w-xl">
              JTCell hadir melayani Anda secara langsung di 3 kota utama di Pulau Flores. Klik cabang untuk melihat kontak resmi dan lokasi peta.
            </p>
          </div>
                  ...
                  >
                    <div className="flex gap-4 items-center">
                      <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 shadow-lg ${
                        isActive ? 'bg-indigo-500 text-white shadow-indigo-500/20' : 'bg-white/5 text-white/55'
                      }`}>
                        <span className="material-symbols-outlined text-[22px]">storefront</span>
                      </div>
                      <div>
                        <h4 className="font-bold text-white text-base leading-tight mb-1">{branch.name}</h4>
                        <p className="text-xs text-white/40 mb-1">{branch.desc}</p>
                        <p className="text-xs text-indigo-400 font-semibold">{branch.addr}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2 shrink-0">
                      <a 
                        ...
                        className="p-2 rounded-lg bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 border border-[#25D366]/20 transition-all flex items-center justify-center shadow-sm"
                      ...
                      <a 
                        ...
                        rel="noopener noreferrer" 
                        onClick={(e) => e.stopPropagation()}
                        className="p-2 rounded-lg bg-indigo-500/10 text-indigo-400 hover:bg-indigo-500/20 border border-indigo-500/20 transition-all flex items-center justify-center shadow-sm"
                        title="Google Maps"
                      >
          ...
          <div className="relative w-72 bg-[#0F172A] h-full flex flex-col shadow-2xl animate-slide-in-left border-r border-white/5">
            <div className="flex items-center justify-between p-6 border-b border-white/5 bg-white/[0.02]">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-indigo-500 to-violet-500 flex items-center justify-center overflow-hidden p-0.5">
                  <img 
                    src="/logo-jtcell-uploaded.png" 
                    alt="JTCell Logo" 
